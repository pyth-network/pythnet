...
fn test_update_accumulator_sysvar() {
    ...
    bank = Bank::warp_from_parent(
        ...
        &Pubkey::default(),
        target_slot,
        solana_runtime::accounts_db::CalcAccountsHashDataSource::Indexes,
    );
...
fn test_update_accumulator_end_of_block() {
    ...
    bank = Bank::warp_from_parent(
        ...
        &Pubkey::default(),
        target_slot,
        crate::accounts_db::CalcAccountsHashDataSource::IndexForTests,
    );
    ...
    assert_eq!(
        updated_wormhole_message_account.data(),
        expected_wormhole_message.message.try_to_vec().unwrap()
    );
}
