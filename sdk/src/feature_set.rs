...
pub mod neon_evm_compute_budget {
    solana_sdk::declare_id!("37Abe7P72Qtq9NEkYVfccGNG3omN8XXyHruA9NQ2uH6t");
}
...
pub mod enable_bpf_loader_set_authority_checked_ix {
    solana_sdk::declare_id!("FvUP6GVssBgsEa8boC8aYRfq2iLcWXadQjhGhsJEZxMp");
}

pub mod enable_alt_bn128_syscall {
    solana_sdk::declare_id!("D1siKyY8iovVZnmhjvGAxyujj3Hkd3oJway9exLpL5rJ");
}

pub mod enable_program_redeployment_cooldown {
    solana_sdk::declare_id!("4bSvUi9QXgomV1Q5peC5AHZUCX3yv1KNsCosxBSeeYgq");
}
...
pub mod update_hashes_per_tick {
    solana_sdk::declare_id!("8SkdHaJCQejuePPZyr3cLa9YekLGaVgnGpQZYkr22FiY");
}

pub mod enable_big_mod_exp_syscall {
    solana_sdk::declare_id!("Eo93UDmAnFhNmaZiLFJMmeGn4vYPKtqBiTN7MrG1YwKE");
}

pub mod disable_builtin_loader_ownership_chains {
    solana_sdk::declare_id!("GRNsxkoDrd6uHe9Voow4NuxuwnTFMmXrxNxraKeM6ibK");
}
