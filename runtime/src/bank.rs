...
impl Bank {
    ...
    fn update_accumulator_impl(&self) -> std::result::Result<(), AccumulatorUpdateError> {
        ...
        let accumulator_data = {
            ...
            let accounts_data = &mut borsh0_9::try_to_vec(&accounts.clone().collect::<Vec<_>>())?;
            data.append(acc_state_magic);
            data.append(&mut borsh0_9::try_to_vec(&self.slot())?);
            data.append(&mut borsh0_9::try_to_vec(&ACCUMULATOR_RING_SIZE)?);
    ...
    fn post_accumulator_attestation(
        ...
        use {
            ...
            solana_sdk::borsh0_9::try_from_slice_unchecked,
        };
        ...
        sequence.sequence += 1;
        let sequence = solana_sdk::borsh0_9::try_to_vec(&sequence)
        ...
        let message = solana_sdk::borsh0_9::try_to_vec(&message)
